...
export default function CaseDetails({ selectedCase, onBack }: CaseDetailsProps) {
  return (
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-3">
            <span className={`inline-flex items-center px-4 py-2 rounded-xl text-sm font-semibold border ${selectedCase.statusBg} ${selectedCase.statusColor} ${selectedCase.statusBorder}`}>
              <div className={`w-2 h-2 rounded-full mr-2 ${selectedCase.status === 'Needs Review' ? 'bg-purple-400' : 'bg-sky-400'}`}></div>
              {selectedCase.status}
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-mono text-lg italic">{selectedCase.caseId}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/60 rounded-2xl p-6 border border-slate-200/40">
              <h3 className="font-semibold text-slate-700 mb-4">Case Progress</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-slate-600">{selectedCase.progress}</span>
                  <span className="text-slate-800 font-semibold">{selectedCase.progressPercent}%</span>
                </div>
            ...
            {/* Case Overview */}
            <div className="bg-white/60 rounded-2xl p-6 border border-slate-200/40">
              <h3 className="font-semibold text-slate-700 mb-4">Case Overview</h3>
              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="text-slate-600">Review Status</span>
                  <span className="font-medium text-slate-800">{selectedCase.reviewInfo}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-600">Last Activity</span>
                  <span className="font-medium text-slate-800">{selectedCase.lastActivity}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-600">Time in Queue</span>
                  <span className="font-medium text-slate-800">{selectedCase.queueTime}</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3 p-4 bg-white/70 rounded-xl">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-slate-800">Documents reviewed and approved</p>
                    <p className="text-xs text-slate-500 mt-1">{selectedCase.lastActivity}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3 p-4 bg-white/70 rounded-xl">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div className="flex-1">
                    <p className="text-sm font-medium text-slate-800">Case status updated</p>
                ...
                <div className="flex items-start space-x-3 p-4 bg-white/70 rounded-xl">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-slate-800">Client notification sent</p>
                ...
                <div className="flex items-start space-x-3 p-4 bg-white/70 rounded-xl">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-slate-800">Case created and assigned</p>
                    <p className="text-xs text-slate-500 mt-1">{selectedCase.queueTime} ago</p>
                  </div>
                </div>
              </div>
            </div>
