...
export default function CaseDetailsNew({
  ...
  return (
    <div className="fixed inset-0 z-50 animate-fadeIn p-6">
      <div className="w-full h-full bg-[#C1D9F6]/15 border border-[#C1D9F6]/40 rounded-3xl shadow-2xl backdrop-blur-sm">
        <div className="h-full max-h-full flex flex-col overflow-hidden rounded-3xl">
          {/* Compact Header */}
          <div className="bg-white/90 backdrop-blur-xl border-b border-[#C1D9F6]/30 p-4 flex-shrink-0 animate-slideInLeft rounded-t-3xl">
