                    ...
                    <div className={cn(
                      ...
                      <div className="grid grid-cols-5 gap-3 items-center">
                        ...
                        <div className="flex items-center space-x-1.5 text-xs whitespace-nowrap">
                          ...
                          <span>
                            <span className="text-slate-800 font-semibold">{caseItem.tasksComplete}</span>
                            <span className="text-slate-500 ml-1">Tasks Complete</span>
                          </span>
                        </div>
                        ...
                        <div className="flex items-center space-x-1.5 text-xs whitespace-nowrap">
                          ...
                          <span>
                            <span className="text-slate-800 font-semibold">{caseItem.dateCompleted.split(',')[0]}</span>
                            <span className="text-slate-500 ml-1">{caseItem.dateCompleted.split(',').slice(1).join(',')}</span>
                          </span>
                        </div>
                        ...
                        <div className="flex items-center space-x-1.5 text-xs whitespace-nowrap">
                          ...
                          <span>
                            <span className="text-slate-800 font-semibold">{caseItem.daysInQueue}</span>
                            <span className="text-slate-500 ml-1">Days in Queue</span>
                          </span>
                        </div>
                        ...
                        <div className="flex items-center space-x-1.5 text-xs whitespace-nowrap">
                          ...
                          <span>
                            <span className="text-slate-800 font-semibold">{caseItem.caseType}</span>
                          </span>
                        </div>
                      </div>
                    </div>
