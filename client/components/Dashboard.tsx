...
const FuturisticCaseScroller = ({
  ...
  return (
    <div className="bg-gradient-to-b from-white/95 via-slate-50/40 to-white/95 border border-slate-200/80 rounded-3xl shadow-xl backdrop-blur-md flex flex-col" style={{ height: 'calc(100vh - 420px)' }}>
      {/* Fixed Search Header */}
