...
const FuturisticCaseScroller = ({
  ...
  return (
    <div className="bg-gradient-to-b from-white/95 via-slate-50/40 to-white/95 border border-slate-200/80 rounded-3xl shadow-xl backdrop-blur-md flex flex-col overflow-hidden" style={{ height: 'calc(100vh - 340px)' }}>
      {/* Fixed Search Header */}
      <div className="flex-shrink-0 bg-white/90 border-b border-slate-200/60 p-4 backdrop-blur-sm rounded-t-3xl">
        ...
        return (
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="group relative bg-gradient-to-br from-blue-50/80 via-white to-indigo-50/60 border border-blue-200/30 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="flex items-center justify-between">
                  <div>
