    ...
    <div className="h-full overflow-y-auto px-8 py-10 relative">
      ...
      <div className="relative z-10 text-center mb-12">
        <div className={`transition-all duration-1000 ease-out delay-300 ${createStep ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-4"}`}>
          <h1 className="text-4xl font-light text-[#0E315C] mb-4 tracking-wide">Create New Case</h1>
          <p className="text-[#0E315C]/70 text-base leading-relaxed">Build a new case with intelligent document collection</p>
        </div>
        {onClose && (
          <button
            onClick={onClose}
      ...
      <div className="flex-1">
          ...
          <div className={`relative z-10 space-y-8 transition-all duration-1000 ease-out delay-700 ${createStep === 1 ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-4"}`}>
            ...
            <div className="space-y-6">
              <button
                ...
                className="w-full bg-white/50 backdrop-blur-md border-2 border-[#C1D9F6]/50 hover:border-[#99C0F0] hover:bg-white/70 hover:shadow-2xl hover:shadow-[#99C0F0]/10 transition-all duration-500 p-8 rounded-2xl text-left group hover:scale-[1.02] transform"
              >
                <div className="flex items-start space-x-6">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#99C0F0] to-[#C5BFEE] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-500 flex-shrink-0 shadow-lg">
                    <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-medium text-[#0E315C] mb-2">AI Assist</h3>
              ...
              <button
                ...
                className="w-full bg-white/50 backdrop-blur-md border-2 border-[#C1D9F6]/50 hover:border-[#C5BFEE] hover:bg-white/70 hover:shadow-2xl hover:shadow-[#C5BFEE]/10 transition-all duration-500 p-8 rounded-2xl text-left group hover:scale-[1.02] transform"
              >
                <div className="flex items-start space-x-6">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#C5BFEE] to-[#C1D9F6] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-500 flex-shrink-0 shadow-lg">
                    <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-medium text-[#0E315C] mb-2">Manual Select</h3>
                    <p className="text-[#0E315C]/70 text-base leading-relaxed">
              ...
              <button
                ...
                className="w-full bg-white/50 backdrop-blur-md border-2 border-[#C1D9F6]/50 hover:border-[#C1D9F6] hover:bg-white/70 hover:shadow-2xl hover:shadow-[#C1D9F6]/10 transition-all duration-500 p-8 rounded-2xl text-left group hover:scale-[1.02] transform"
              >
                <div className="flex items-start space-x-6">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#C1D9F6] to-[#99C0F0] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-500 flex-shrink-0 shadow-lg">
                    <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-medium text-[#0E315C] mb-2">Questionnaire</h3>
                    <p className="text-[#0E315C]/70 text-base leading-relaxed">
        ...
        {createStep === 2 && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-medium text-[#0E315C] mb-1">Select Documents</h2>
                <p className="text-[#0E315C]/70 text-sm">Choose documents to request from your client</p>
              </div>
              <button
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-[#C1D9F6]/40 rounded-2xl p-6">
              <div className="text-center text-[#0E315C]/60 py-8">
                ...
                <p className="text-sm">Document selection interface will be implemented here</p>
                <p className="text-xs mt-2 opacity-60">Selected method: {createMethod}</p>
              </div>
            </div>
        ...
        {createStep === 3 && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-medium text-[#0E315C] mb-1">Case Information</h2>
                <p className="text-[#0E315C]/70 text-sm">Enter basic information for this case</p>
              </div>
              <button
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-[#C1D9F6]/40 rounded-2xl p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#0E315C] mb-2">First Name</label>
                  <input
                    type="text"
                    value={caseInfo.firstName}
                    onChange={(e) => setCaseInfo(prev => ({ ...prev, firstName: e.target.value }))}
                ...
                <div>
                  <label className="block text-sm font-medium text-[#0E315C] mb-2">Last Name</label>
                  <input
                    type="text"
                    value={caseInfo.lastName}
                    onChange={(e) => setCaseInfo(prev => ({ ...prev, lastName: e.target.value }))}
                    className="w-full px-3 py-2 bg-white/80 border border-[#C1D9F6] rounded-lg text-[#0E315C] placeholder-[#0E315C]/50 focus:outline-none focus:ring-2 focus:ring-[#99C0F0]/50 focus:border-[#99C0F0] transition-all"
              ...
              <div>
                <label className="block text-sm font-medium text-[#0E315C] mb-2">Email</label>
                <input
                  type="email"
                  value={caseInfo.email}
                  onChange={(e) => setCaseInfo(prev => ({ ...prev, email: e.target.value }))}
                  className="w-full px-3 py-2 bg-white/80 border border-[#C1D9F6] rounded-lg text-[#0E315C] placeholder-[#0E315C]/50 focus:outline-none focus:ring-2 focus:ring-[#99C0F0]/50 focus:border-[#99C0F0] transition-all"
                  placeholder="Enter email address"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-[#0E315C] mb-2">Phone (Optional)</label>
                <input
                  type="tel"
                  value={caseInfo.phone}
                  onChange={(e) => setCaseInfo(prev => ({ ...prev, phone: e.target.value }))}
                  className="w-full px-3 py-2 bg-white/80 border border-[#C1D9F6] rounded-lg text-[#0E315C] placeholder-[#0E315C]/50 focus:outline-none focus:ring-2 focus:ring-[#99C0F0]/50 focus:border-[#99C0F0] transition-all"
            ...
            <div className="flex justify-end">
              <button
                ...
                disabled={!caseInfo.firstName || !caseInfo.lastName || !caseInfo.email}
        ...
        {createStep === 4 && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-medium text-[#0E315C] mb-1">Review & Create</h2>
                <p className="text-[#0E315C]/70 text-sm">Review all details before creating the case</p>
              </div>
              <button
                onClick={() => handleStepTransition(3)}
                className="flex items-center space-x-2 px-3 py-2 text-[#0E315C]/60 hover:text-[#0E315C] hover:bg-[#C1D9F6]/20 rounded-lg transition-all text-sm"
            ...
            <div className="space-y-4">
              <div className="bg-white/60 backdrop-blur-sm border border-[#C1D9F6]/40 rounded-2xl p-6">
                <h3 className="text-sm font-medium text-[#0E315C] mb-3">Case Summary</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-[#0E315C]/70">Method:</span>
                    <span className="text-[#0E315C] capitalize">{createMethod}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[#0E315C]/70">Client:</span>
                    <span className="text-[#0E315C]">{caseInfo.firstName} {caseInfo.lastName}</span>
                  </div>
                  <div className="flex justify-between">
            ...
            <div className="flex justify-end">
              <button
                onClick={() => {
                  ...
                  setCaseInfo({ firstName: "", lastName: "", email: "", phone: "", caseType: "" });
                }}
