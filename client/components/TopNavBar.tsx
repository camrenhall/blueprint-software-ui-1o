            ...
            <div className="flex items-center space-x-6">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="relative p-2 no-focus rounded-full hover:bg-white/5 transition-all duration-300"
                  >
                    <Bell className="w-4 h-4 text-[#0E315C]/70" />
                    {taskCount > 0 && (
                      <Badge className="absolute -top-1 -right-1 w-5 h-5 flex items-center justify-center p-0 text-xs bg-[#C5BFEE]/80 text-white border border-white/30 animate-pulse hover:bg-[#C5BFEE]/80 pointer-events-none">
                        {taskCount}
                      </Badge>
                    )}
                  </Button>
                ...
                >
                    ...
                    latestTasks.map((task) => (
                      <DropdownMenuItem
                        ...
                        onClick={() => {
                          ...
                          navigate(
                            `/menu?view=taskqueue&taskId=${task.id}&t=${Date.now()}`,
                            { replace: true },
                          );
                        }}
                      >
                  ...
                  <DropdownMenuItem
                    ...
                    onClick={() => {
                      ...
                      navigate(`/menu?view=taskqueue&t=${Date.now()}`, {
                        replace: true,
                      });
                    }}
                  >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className="flex items-center space-x-2 px-3 py-2 no-focus rounded-full hover:bg-white/5 transition-all duration-300"
                  >
