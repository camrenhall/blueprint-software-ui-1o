...
export default function WelcomeLoader({ userName }: WelcomeLoaderProps) {
  ...
  const [stage, setStage] = useState<"loading" | "welcome" | "fadeOut">(
    "loading",
  );
        ...
        >
          <div className="relative">
            ...
            <div className="absolute inset-0 pointer-events-none">
              <div
                className="absolute -top-2 left-1/2 w-1 h-1 bg-blue-300/60 rounded-full animate-float"
                style={{ animationDelay: "0s" }}
              />
              <div
                className="absolute top-1/2 -right-2 w-1.5 h-1.5 bg-white/50 rounded-full animate-float"
                style={{ animationDelay: "1s" }}
              />
              <div
                className="absolute -bottom-2 left-1/2 w-1 h-1 bg-blue-200/40 rounded-full animate-float"
                style={{ animationDelay: "2s" }}
              />
              <div
                className="absolute top-1/2 -left-2 w-1.5 h-1.5 bg-purple-300/50 rounded-full animate-float"
      ...
      {stage === "welcome" && (
        ...
        >
          <div className="text-center">
            ...
            <div className="absolute inset-0 pointer-events-none">
              <div
                className="absolute top-1/4 left-1/4 w-3 h-3 bg-blue-300/60 rounded-full animate-float"
                style={{ animationDelay: "0s" }}
              />
              <div
                className="absolute top-1/3 right-1/4 w-2 h-2 bg-white/50 rounded-full animate-float"
                style={{ animationDelay: "1s" }}
              />
              <div
                className="absolute bottom-1/4 left-1/3 w-2.5 h-2.5 bg-purple-300/50 rounded-full animate-float"
                style={{ animationDelay: "2s" }}
              />
              <div
                className="absolute top-1/2 right-1/3 w-1.5 h-1.5 bg-blue-200/60 rounded-full animate-float"
                style={{ animationDelay: "1.5s" }}
              />
            </div>
          </div>
