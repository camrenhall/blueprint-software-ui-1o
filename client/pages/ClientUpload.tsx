...
export default function ClientUpload() {
  ...
  return (
    <PageContainer
      ...
      className="p-6 h-screen overflow-hidden"
    >
      <div
      ...
      >
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-light text-[#0E315C]">
                Document Upload Portal
              </h1>
              <p className="text-sm text-[#0E315C]/60">
                Secure document submission for legal review
              </p>
            </div>
          </div>
            ...
            <div className="col-span-1 space-y-4">
              ...
              <GlassPanel variant="light" radius="lg" className="p-4">
                <div className="text-center space-y-3">
                  ...
                  <div>
                    <h3 className="font-medium text-[#0E315C] text-sm">
                      {clientEmail}
                    </h3>
              ...
              <GlassPanel variant="enhanced" radius="lg" className="p-4">
                <h3 className="font-medium text-[#0E315C] mb-3 text-sm">
                  Upload Overview
                </h3>
                ...
                <div
                  className={`border-2 border-dashed rounded-xl h-32 transition-all duration-300 flex items-center justify-center cursor-pointer ${
                    isDragOver
                      ...
                      : "border-[#C1D9F6]/60 bg-white/20 hover:border-[#99C0F0] hover:bg-[#99C0F0]/5"
                  }`}
                ...
                >
                  <div className="text-center">
                    <div className="flex justify-center mb-3">
                      <div
                        className={`p-3 rounded-full ${isDragOver ? "bg-[#99C0F0]/20" : "bg-[#C1D9F6]/20"}`}
                      >
                        <Upload
                          className={`w-6 h-6 ${isDragOver ? "text-[#99C0F0]" : "text-[#0E315C]/60"}`}
                        />
                      </div>
                    </div>
                    ...
                    <div className="h-full flex items-center justify-center px-8">
                      <div className="text-center space-y-6 w-full max-w-md">
                        ...
                        <div className="space-y-4">
                          <h4 className="text-xl font-medium text-[#0E315C]/60">
                    ...
                    <div className="h-full overflow-y-auto pr-2 document-scroll">
                      <div className="space-y-3">
                        {files.map((file) => (
                          <div
                            key={file.id}
                            className="flex items-center space-x-4 p-4 bg-white/30 rounded-lg border border-white/20 hover:bg-white/40 transition-colors"
                          >
                            <div className="flex-shrink-0">
                              {getFileTypeIconSvg(file.file.name)}
                            </div>
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between mb-2">
                                <h4 className="text-sm font-medium text-[#0E315C] truncate">
                                  {file.file.name}
                                </h4>
                                <div className="flex items-center space-x-2">
                ...
                <GlassPanel variant="light" radius="lg" className="p-4">
                  <div className="space-y-3">
                    ...
                    {validationErrors.map((error, index) => (
                      <div
                        key={index}
                        className="flex items-start space-x-3 p-3 bg-red-50/50 rounded-lg border border-red-200/50"
                      >
