...
export default function ClientUpload() {
  ...
  // Helper function to get periwinkle SVG icons for file types
  const getFileTypeIconSvg = (filename: string) => {
    const extension = filename.slice(filename.lastIndexOf('.')).toLowerCase();
    const iconColor = "#99C0F0"; // Periwinkle color

    switch (extension) {
      case '.pdf':
        return (
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6z" fill={iconColor} fillOpacity="0.1" stroke={iconColor} strokeWidth="1.5"/>
            <path d="M14 2v6h6" stroke={iconColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M10 12h4" stroke={iconColor} strokeWidth="1.5" strokeLinecap="round"/>
            <path d="M10 16h2" stroke={iconColor} strokeWidth="1.5" strokeLinecap="round"/>
          </svg>
        );
      case '.png':
      case '.jpg':
      case '.jpeg':
        return (
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M18 3H6a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V6a3 3 0 0 0-3-3z" fill={iconColor} fillOpacity="0.1" stroke={iconColor} strokeWidth="1.5"/>
            <circle cx="8.5" cy="8.5" r="1.5" fill={iconColor}/>
            <path d="M21 15l-5-5L5 21" stroke={iconColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        );
      case '.doc':
      case '.docx':
        return (
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6z" fill={iconColor} fillOpacity="0.1" stroke={iconColor} strokeWidth="1.5"/>
            <path d="M14 2v6h6" stroke={iconColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M8 10h8" stroke={iconColor} strokeWidth="1.5" strokeLinecap="round"/>
            <path d="M8 14h8" stroke={iconColor} strokeWidth="1.5" strokeLinecap="round"/>
            <path d="M8 18h5" stroke={iconColor} strokeWidth="1.5" strokeLinecap="round"/>
          </svg>
        );
      default:
        return (
