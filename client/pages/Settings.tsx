...
export default function Settings() {
  ...
  return (
    <div className="h-screen w-full relative overflow-hidden pt-16">
      ...
      <div className="absolute inset-6 bg-gradient-to-br from-white/10 via-[#C1D9F6]/5 to-white/5 backdrop-blur-sm rounded-2xl border border-white/10 shadow-xl" />
        ...
        <div className={cn(
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-[#99C0F0]/20 to-[#C5BFEE]/20 backdrop-blur-sm border border-white/20">
              ...
              <TabsContent value="automation" className="space-y-6 mt-8">
                <Card className="bg-white/5 backdrop-blur-sm border-white/10">
                  <CardHeader>
                    ...
                    <CardDescription className="text-[#0E315C]/60">
                      Configure AI behavior and automation settings for discovery processes
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <SettingItem
              ...
              <TabsContent value="integration" className="space-y-6 mt-8">
                <Card className="bg-white/5 backdrop-blur-sm border-white/10">
                  <CardHeader>
                    ...
                    <CardDescription className="text-[#0E315C]/60">
                      Manage connections to third-party services and data export preferences
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <SettingItem
              ...
              <TabsContent value="team" className="space-y-6 mt-8">
                <Card className="bg-white/5 backdrop-blur-sm border-white/10">
                  <CardHeader>
                    ...
                    <CardDescription className="text-[#0E315C]/60">
                      Manage team access and sharing preferences for legal teams
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <SettingItem
              ...
              <TabsContent value="billing" className="space-y-6 mt-8">
                <Card className="bg-white/5 backdrop-blur-sm border-white/10">
                  <CardHeader>
                    ...
                    <CardDescription className="text-[#0E315C]/60">
                      Monitor usage and manage billing preferences for your subscription
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <SettingItem
          ...
          <div className="flex justify-end pt-6 border-t border-white/10 mt-8">
            <Button className="bg-gradient-to-r from-[#99C0F0] to-[#C5BFEE] hover:from-[#99C0F0]/80 hover:to-[#C5BFEE]/80 text-white px-8 py-2">
              Save Changes
            </Button>
          </div>
        </div>
